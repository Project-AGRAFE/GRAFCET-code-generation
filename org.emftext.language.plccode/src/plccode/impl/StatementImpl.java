 ...
 * </p>
 * <ul>
 *   <li>{@link plccode.impl.StatementImpl#getEmbeddedStatements <em>Embedded Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatementImpl extends ExpressionImpl implements Statement {
	...
	protected EClass eStaticClass() {
		return PlccodePackage.Literals.STATEMENT;
	}
	...
	public EList<Expression> getEmbeddedStatements() {
		if (embeddedStatements == null) {
			embeddedStatements = new EObjectContainmentEList<Expression>(Expression.class, this, PlccodePackage.STATEMENT__EMBEDDED_STATEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlccodePackage.STATEMENT__EMBEDDED_STATEMENTS:
