 ...
 * </p>
 * <ul>
 *   <li>{@link plccode.impl.InputVariableImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputVariableImpl extends MinimalEObjectImpl.Container implements InputVariable {
	...
	protected EClass eStaticClass() {
		return PlccodePackage.Literals.INPUT_VARIABLE;
	}
	...
	public EList<PlcVariable> getVars() {
		if (vars == null) {
			vars = new EObjectContainmentEList<PlcVariable>(PlcVariable.class, this, PlccodePackage.INPUT_VARIABLE__VARS);
		}
		return vars;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlccodePackage.INPUT_VARIABLE__VARS:
