 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.declaration.impl.DocumentationImpl#getDocuText <em>Docu Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentationImpl extends EObjectImpl implements Documentation {
	...
	protected EClass eStaticClass() {
		return DeclarationPackage.Literals.DOCUMENTATION;
	}
	...
	public void setDocuText(String newDocuText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarationPackage.DOCUMENTATION__DOCU_TEXT, oldDocuText, docuText));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DeclarationPackage.DOCUMENTATION__DOCU_TEXT:
				return getDocuText();
		}
