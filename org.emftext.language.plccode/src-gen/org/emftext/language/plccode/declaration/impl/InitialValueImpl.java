 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.declaration.impl.InitialValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitialValueImpl extends EObjectImpl implements InitialValue {
	...
	protected EClass eStaticClass() {
		return DeclarationPackage.Literals.INITIAL_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeclarationPackage.INITIAL_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DeclarationPackage.INITIAL_VALUE__VALUE:
				return getValue();
		}
