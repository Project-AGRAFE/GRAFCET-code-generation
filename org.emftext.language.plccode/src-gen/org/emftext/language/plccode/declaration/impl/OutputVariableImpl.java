 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.declaration.impl.OutputVariableImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputVariableImpl extends EObjectImpl implements OutputVariable {
	...
	protected EClass eStaticClass() {
		return DeclarationPackage.Literals.OUTPUT_VARIABLE;
	}
	...
	public EList<PlcVariable> getVars() {
		if (vars == null) {
			vars = new EObjectContainmentEList<PlcVariable>(PlcVariable.class, this, DeclarationPackage.OUTPUT_VARIABLE__VARS);
		}
		return vars;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DeclarationPackage.OUTPUT_VARIABLE__VARS:
