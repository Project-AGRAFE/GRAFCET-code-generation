 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.structuredtext.impl.WhileImpl#getBreakCondition <em>Break Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhileImpl extends StatementImpl implements While {
	...
	protected EClass eStaticClass() {
		return StructuredtextPackage.Literals.WHILE;
	}
	...
	public NotificationChain basicSetBreakCondition(Condition newBreakCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructuredtextPackage.WHILE__BREAK_CONDITION, oldBreakCondition, newBreakCondition);
	...
	public void setBreakCondition(Condition newBreakCondition) {
		if (newBreakCondition != breakCondition) {
			...
			if (breakCondition != null)
				msgs = ((InternalEObject)breakCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructuredtextPackage.WHILE__BREAK_CONDITION, null, msgs);
			if (newBreakCondition != null)
				msgs = ((InternalEObject)newBreakCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructuredtextPackage.WHILE__BREAK_CONDITION, null, msgs);
			msgs = basicSetBreakCondition(newBreakCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredtextPackage.WHILE__BREAK_CONDITION, newBreakCondition, newBreakCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredtextPackage.WHILE__BREAK_CONDITION:
