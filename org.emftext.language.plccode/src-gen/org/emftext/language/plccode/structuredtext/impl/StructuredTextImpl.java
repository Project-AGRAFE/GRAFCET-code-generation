...
import org.emftext.language.plccode.impl.SpecificationImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.structuredtext.impl.StructuredTextImpl#getEmbeddedStatements <em>Embedded Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructuredTextImpl extends SpecificationImpl implements StructuredText {
	...
	public EList<Expression> getEmbeddedStatements() {
		if (embeddedStatements == null) {
			embeddedStatements = new EObjectContainmentEList<Expression>(Expression.class, this, StructuredtextPackage.STRUCTURED_TEXT__EMBEDDED_STATEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredtextPackage.STRUCTURED_TEXT__EMBEDDED_STATEMENTS:
