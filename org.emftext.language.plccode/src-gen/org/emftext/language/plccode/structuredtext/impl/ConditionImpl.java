 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.plccode.structuredtext.impl.ConditionImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends EObjectImpl implements Condition {
	...
	protected EClass eStaticClass() {
		return StructuredtextPackage.Literals.CONDITION;
	}
	...
	public void setTerm(String newTerm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredtextPackage.CONDITION__TERM, oldTerm, term));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructuredtextPackage.CONDITION__TERM:
				return getTerm();
		}
