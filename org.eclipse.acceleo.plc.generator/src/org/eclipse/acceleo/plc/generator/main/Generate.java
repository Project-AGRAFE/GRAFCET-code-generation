...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/plc/generator/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(PlccodePackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
            resourceSet.getPackageRegistry().put(PlccodePackage.eNS_URI, PlccodePackage.eINSTANCE);
        }
    }
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("plccode", new XMIResourceFactoryImpl());
    }
